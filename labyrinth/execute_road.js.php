...
<HTML>
    <HEAD>
        ...
        <SCRIPT type='text/javascript' src='./program_road.js'></SCRIPT>
        <STYLE type='text/css'>
            <!--
                /*DIV#maze{
                    letter-spacing: -2pt;
    ...
    <BODY>
        <DIV id='maze'></DIV>
        <FORM method='POST' action='http://202.171.139.242/~hisayuki.mashimo/program/maze/execute_road.js.php'>
            <FIELDSET>
                <LEGEND>迷路の規模</LEGEND>
