    ...
    <body>
        ...
        <script type="text/javascript">
            window.onload = function(){
                ...
                var PentagramThetaObject = Operater.summons('Pentagram_Theta', frame_node01, params01);
                ...
                var animate = function(){
                    PentagramThetaObject.setDirection(theta_R, theta_V, theta_L);
                    PentagramThetaObject.output();
