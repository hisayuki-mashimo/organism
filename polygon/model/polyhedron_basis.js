  ...
  output = (embody) => {
    ...
    for (let i = 0; i < embody.moment_surfaces.length; i++) {
      ...
      for (let j = 0; j < surface.length; j++) {
        ...
        console.log(surface[j], pos);
        if (j == 0) {
          embody.canvas_context.moveTo(
            embody._center + pos.X,
            embody._center + pos.Y
          );
        } else {
          embody.canvas_context.lineTo(
            embody._center + pos.X,
            embody._center + pos.Y
          );
        }
      ...
      embody.canvas_context.fillStyle = "rgba(255, 255, 255, 0.8)";
    ...
    for (let i = 0; i < embody.moment_surfaces.length; i++) {
      ...
      if (
        debug_code[2] &&
        embody.debug_fill_style &&
        embody.debug_fill_style[debug_code[2]]
      ) {
        embody.canvas_context.fillStyle =
          embody.debug_fill_style[debug_code[2]];
        embody.canvas_context.fill();
      }
      if (
