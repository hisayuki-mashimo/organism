...
BlockOperator.prototype = {
  ...
  instantObject: function()
  {
    ...
    this.active_object.block_type  = this.waiting_object.block_type;
...
block_a = {block_type: 'a', formations: new Array({left:  0, top:  0}, {left: -1, top:  0}, {left:  1, top:  0}, {left:  0, top:  1}), aim_count: new Number(4)};
block_b = {block_type: 'b', formations: new Array({left:  0, top:  0}, {left: -1, top:  0}, {left:  1, top:  0}, {left: -1, top:  1}), aim_count: new Number(4)};
block_c = {block_type: 'c', formations: new Array({left:  0, top:  0}, {left: -1, top:  0}, {left:  1, top:  0}, {left:  1, top:  1}), aim_count: new Number(4)};
block_d = {block_type: 'd', formations: new Array({left:  0, top:  0}, {left: -1, top:  0}, {left: -1, top: -1}, {left:  0, top:  1}), aim_count: new Number(2)};
block_e = {block_type: 'e', formations: new Array({left:  0, top:  0}, {left:  0, top:  1}, {left:  1, top:  0}, {left:  1, top: -1}), aim_count: new Number(2)};
block_f = {block_type: 'f', formations: new Array({left:  0, top:  0}, {left: -1, top:  0}, {left: -1, top: -1}, {left:  0, top: -1}), aim_count: new Number(1)};
block_g = {block_type: 'g', formations: new Array({left:  0, top:  0}, {left: -1, top:  0}, {left: -2, top:  0}, {left:  1, top:  0}), aim_count: new Number(2)};
