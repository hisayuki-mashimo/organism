...
Signal.prototype = {
    node:      null,
    maze:      null,
    api_url:   new String('http://zhen-xia.hayabusa-lab.jp/organism/maze/16/labyrinth_test.php'),
    operate:   null,
    memory:    null,
    navigator: null,
...
Memory.prototype = {
    ...
    maze:         null,
    log:          null,
    api_url:      new String('http://zhen-xia.hayabusa-lab.jp/organism/maze/16/log.php'),
    api_url_maze: new String('http://zhen-xia.hayabusa-lab.jp/organism/maze/16/labyrinth_test.php'),
