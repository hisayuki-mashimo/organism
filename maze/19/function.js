...
Signal.prototype = {
    api_url:   new String('http://zhen-xia02.hayabusa-lab.jp/organism/maze/19/labyrinth_test.php'),
    node:      null,
    maze:      null,
    log:       null,
    operate:   null,
    ...
    {
        var params = {
            'rgon_Y':         this.operate.rgon_Y.value,
            'rgon_X':         this.operate.rgon_X.value,
...
Navigator.prototype = {
    ...
    configure: function(params)
    {
        ...
        var ver_length     = (params.rgon_Y * length_unit) + 1;
        var nex_length     = (params.rgon_X * length_unit) + 1;
        var absolute_param = $(this.maze).offset();
        var sect_count_ver = params.rgon_Y * params.rgon_side;
        var sect_count_nex = params.rgon_X * params.rgon_side;
        ...
        for(var i = 0; i < (params.rgon_Y - 1); i ++){
            var border_node = document.createElement('div');
            $(border_node).css('position', 'absolute');
        ...
        for(var i = 0; i < (params.rgon_X - 1); i ++){
            var border_node = document.createElement('div');
            $(border_node).css('position', 'absolute');
            $(border_node).css('top', this.absolute_top + 'px');
...
Memory.prototype = {
    ...
    maze:         null,
    log:          null,
    api_url:      new String('http://zhen-xia02.hayabusa-lab.jp/organism/maze/19/log.php'),
    api_url_maze: new String('http://zhen-xia02.hayabusa-lab.jp/organism/maze/19/labyrinth_test.php'),
    ...
    connect: function()
    {
        var ref    = this;
        var params = {
            'rgon_Y':  document.params.rgon_Y.value,
            'rgon_X':  document.params.rgon_X.value,
            'rgon_side': document.params.rgon_side.value
        };
