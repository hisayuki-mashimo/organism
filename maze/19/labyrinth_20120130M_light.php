...
$this->_lb('PRMY', $prmys);
    ...
    protected function _setRgon($Y, $X)
    {
        ...
        foreach(range($rgon->edges['T'], $rgon->edges['B']) as $sect_Y){
            foreach(range($rgon->edges['R'], $rgon->edges['L']) as $sect_X){
