                ...
                <form action="" method="post" name="params">
                    <table>
                        <tr class="odd">
                            ...
                            <td class="value"><div>region/count</div><ul><li>縦: <input type="text" name="rgon_Y" size="2" value="3" />&nbsp;&nbsp;横: <input type="text" name="rgon_X" size="2" value="3" /></li></ul></td>
                        ...
                        <tr class="even">
                            ...
                            <td class="value"><div>region/side</div><ul><li><input type="text" name="rgon_side" size="2" value="8" /></li></ul></td>
                        ...
                        <tr class="odd">
                            ...
                            <td class="value"><div>room/count</div><ul><li><input type="text" name="room_count" size="2" value="4" /></li></ul></td>
                        ...
                        <tr class="odd">
                            ...
                            <td class="value"><div>room/area/dispersion</div><ul><li><input type="text" name="room_area_disp" size="20" value="{'1':2, '2':2}" /></li></ul></td>
                        ...
                        <tr class="even">
                            ...
                            <td class="value"><div>room/padding/min</div><ul><li>最小: <input type="text" name="room_pdng_min"  size="1" value="0" />&nbsp;&nbsp;最大: <input type="text" name="room_pdng_max"  size="4" value="2" /></li></ul></td>
                            <td class="date"><div>2011/02/23 06:28</div></td>
                        </tr>
                    </table>
                </form>
