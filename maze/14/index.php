                ...
                <form action="" method="post" name="params">
                    <table>
                        <tr class="odd">
                            ...
                            <td class="value"><div>region/count</div><ul><li>縦: <input type="text" name="rgon_ver" size="2" value="3" />&nbsp;&nbsp;横: <input type="text" name="rgon_nex" size="2" value="3" /></li></ul></td>
                        ...
                        <tr class="even">
                            ...
                            <td class="value"><div>region/side</div><ul><li>管区: <input type="text" name="rgon_side" size="2" value="5" />&nbsp;&nbsp;境界: <input type="text" name="mete_side" size="2" value="3" /></li></ul></td>
                        ...
                        <tr class="even">
                            ...
                            <td class="value"><div>room/padding/min</div><ul><li>最小: <input type="text" name="room_pdng_min"  size="1" value="0" />&nbsp;&nbsp;最大: <input type="text" name="room_pdng_max"  size="1" value="2" /></li></ul></td>
                            <td class="date"><div>2011/02/23 06:28</div></td>
                        </tr>
                    </table>
                </form>
