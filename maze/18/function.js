...
Signal.prototype = {
    api_url:   new String('http://zhen-xia.hayabusa-lab.jp/organism/maze/18/labyrinth_test.php'),
    node:      null,
    maze:      null,
    log:       null,
    operate:   null,
...
Memory.prototype = {
    ...
    maze:         null,
    log:          null,
    api_url:      new String('http://zhen-xia.hayabusa-lab.jp/organism/maze/18/log.php'),
    api_url_maze: new String('http://zhen-xia.hayabusa-lab.jp/organism/maze/18/labyrinth_test.php'),
